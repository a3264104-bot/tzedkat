...
// §64: נוסף מתג "מצב לקוח" לצדו (סעיף 5).
...
export function SignOutBtn() {
  return (
    <div className="flex items-center gap-2 shrink-0">
      {/* §64: מעבר לתצוגת לקוח בלי להתנתק ולהתחבר מחדש.
          הנציג הוא רשומת Customer לכל דבר, ולכן /account ו-/order
          עובדים לו כמו לכל לקוח - חסרה הייתה רק הדרך לעבור. */}
      <RoleSwitcher mode="agent" />
      <button
