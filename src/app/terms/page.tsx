        ...
        <div className="max-w-none space-y-5 text-brand-slatedark leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pr-6 space-y-1">
              ...
              {/* §272: ביטול הזמנה ששולמה.
                  
                  ⚠️ הסעיף היה חסר: התנאים דיברו על "זיכוי" (פריט
                  חסר, איכות) ולא על **ביטול מלא**. הלקוח שהזמנתו
                  בוטלה לא ידע מה קורה לכסף שלו.
                  
                  ⚠️ הניסוח מפורש שזה **לא החזר כספי** — כי זו
                  שאלה שתישאל, ועדיף שהתשובה תהיה כתובה מראש. */}
              <li>
                <strong>ביטול הזמנה ששולמה:</strong> אם הזמנה מבוטלת לאחר
                שחויבה, מלוא הסכום ששולם נזקף כ<strong>יתרת זכות</strong>{" "}
                לזכות הלקוח ומקוזז אוטומטית מההזמנה הבאה. יתרת הזכות אינה
                מוחזרת ככסף אלא אם סוכם אחרת מול ההנהלה.
              </li>
              <li>
