    ...
    Credentials({
      ...
      async authorize(creds) {
        ...
        for (const customer of customers) {
          ...
          // §125: 🐛 באג חמור שתוקן - לקוחות נחסמו מהחשבון שלהם.
          //
          // התנאי כאן היה `!customer.loginCode` - כלומר הסיסמה
          // נבדקה **רק** ללקוח שאין לו קוד. זה עבד כל עוד רוב
          // הלקוחות היו בלי קוד.
          //
          // אבל §121 התחיל להפיק קוד **לכל לקוח חדש** בהרשמה. מאותו
          // רגע, לקוח שנרשם באתר קיבל קוד אוטומטית, התנאי נכשל,
          // והסיסמה שהוא בחר בטופס **מעולם לא נבדקה**. הוא קיבל
          // "פרטים שגויים" על החשבון שהרגע פתח.
          //
          // הכלל הנכון: **שני המסלולים תמיד פתוחים**. קוד וסיסמה
          // הם שתי דרכים לאותו חשבון, לא חלופות שמבטלות זו את זו:
          //   • קוד    - נמסר ע"י המנהל, נשמע בטלפון
          //   • סיסמה  - הלקוח בחר בעצמו באתר
          //
          // הקוד נבדק ראשון (הוא הקצר יותר), והסיסמה כנפילה.
