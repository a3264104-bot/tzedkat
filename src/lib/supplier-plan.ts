// §51: איסוף נתוני התכנון להזמנה לספק.
//
// ═══════════════════════════════════════════════════════════════
// §63: למה הקובץ הזה נוצר
// ═══════════════════════════════════════════════════════════════
// collectPlan ישבה קודם בתוך src/app/api/admin/supplier-plan/route.ts
// והתייצאה משם. ב-App Router אסור לקובץ route.ts לייצא שום דבר מלבד
// פונקציות ה-HTTP וכמה ערכי תצורה מוכרים, ולכן ה-build נכשל עם:
//   Property 'collectPlan' is incompatible with index signature
//
// הפתרון הוא הפרדה ולא ביטול הייצוא: הפונקציה משמשת גם את מסך
// התכנון וגם את ייצוא האקסל לספק, וזה בדיוק מה ששומר על כך ששניהם
// מציגים את אותם מספרים - העיקרון של §51.
